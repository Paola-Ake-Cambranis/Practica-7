...
* WebMaker.java
*
* Esta clase es utilizada durante la realizaci�n de la pr�ctica 7 de LP2
*
* @author Ing. H�ctor M. Quej Cosgaya
*/
public class WebMaker implements Serializable {
	...
	/**
	* Imprime el encabezado de nuestra p�gina web. El encabezado de una p�gina web
	* est� compuesto por la declaraci�n DOCTYPE, la apertura del documento html,
	* y la cabeza (head), dentro de la cual escribimos el t�tulo de la p�gina. Adicionalmente
	* abrimos la etiqueta del cuerpo (body) para empezar a crear contenido dentro de
	* ella, y escribimos un t�tulo sencillo.
	*/
	...
	*/
	public String imprimirTexto(String texto) {
		...
		// Agregamos el texto reci�n creado a nuestra p�gina
		this.pageBody.append(aux.toString());
		
		// Regresamos el p�rrafo creado
		return aux.toString();
	}
	...
	*/
	public String insertarImagen(String imagename) {
		...
		// Agregamos la imagen reci�n creada a nuestra p�gina
		this.pageBody.append(aux.toString());
	...
	/**
	* Imprime el cierre de nuestra p�gina web. Antes de cerrar el cuerpo (que fue
	* abierto en el encabezado) escribimos un peque�o p�rrafo de muestra. Finalmente
	...
	*/
	...
	/**
	* Imprime el contenido �ntegro de la p�gina web.
	*/ 
	...
	/** 
	* Agrega el contenido del formulario a la p�gina web
	*/
	...
	/** 
	* Guarda la p�gina web con todo el contenido que fue agregado a ella hasta el momento
	*/
